...
*/
?>
<div class="tml tml-resetpass" id="easy-user-profile<?php $template->the_instance(); ?>">
	...
	<form name="resetpassform" id="resetpassform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'resetpass', 'login_post' ); ?>" method="post" autocomplete="off">
		...
		<div class="user-pass1-wrap">
			<p>
				<label for="pass1"><?php _e( 'New password', 'easy-user-profile' ); ?></label>
			</p>
			...
			<div class="wp-pwd">
				...
				<div id="pass-strength-result" class="hide-if-no-js" aria-live="polite"><?php _e( 'Strength indicator', 'easy-user-profile' ); ?></div>
			</div>
			<div class="pw-weak">
				<label>
		...
		<p class="user-pass2-wrap">
			<label for="pass2"><?php _e( 'Confirm new password', 'easy-user-profile' ); ?></label>
		...
		<p class="tml-submit-wrap">
			<input type="submit" name="wp-submit" id="wp-submit<?php $template->the_instance(); ?>" value="<?php esc_attr_e( 'Reset Password', 'easy-user-profile' ); ?>" />
